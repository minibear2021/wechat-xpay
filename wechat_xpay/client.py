...
class XPayClient(BaseClient):
    ...
    def cancel_currency_pay(
        ...
        if user_ip:
            payload["user_ip"] = user_ip
        response = self._http_post("/xpay/cancel_currency_pay", payload, access_token, session_key)
    ...
    def present_currency(
        ...
        response = self._http_post("/xpay/present_currency", payload, access_token, session_key)
    ...
    def query_order(
        ...
        response = self._http_post("/xpay/query_order", payload, access_token, session_key)
    ...
    def refund_order(
        ...
        response = self._http_post("/xpay/refund_order", payload, access_token, session_key)
    ...
    def query_withdraw_order(
        ...
        response = self._http_post("/xpay/query_withdraw_order", payload, access_token, session_key)
    ...
    def download_bill(
        ...
        response = self._http_post("/xpay/download_bill", payload, access_token, session_key)
    ...
    def query_biz_balance(
        ...
        """
        payload: dict[str, Any] = {}
        response = self._http_post("/xpay/query_biz_balance", payload, access_token, session_key)
    ...
    def query_adver_funds(
        ...
        response = self._http_post("/xpay/query_adver_funds", payload, access_token, session_key)
    ...
    def get_complaint_list(
        ...
        response = self._http_post("/xpay/get_complaint_list", payload, access_token, session_key)
    ...
    def get_complaint_detail(
        ...
        response = self._http_post("/xpay/get_complaint_detail", payload, access_token, session_key)
    ...
    def response_complaint(
        ...
        self._http_post("/xpay/response_complaint", payload, access_token, session_key)
        return True
    ...
    def complete_complaint(
        ...
        """
        payload = {"complaint_id": complaint_id}
        self._http_post("/xpay/complete_complaint", payload, access_token, session_key)
        return True
    ...
    def upload_vp_file(
        ...
        response = self._http_post("/xpay/upload_vp_file", payload, access_token, session_key)
    ...
    def notify_provide_goods(
        ...
        if wx_order_id:
            payload["wx_order_id"] = wx_order_id
        response = self._http_post("/xpay/notify_provide_goods", payload, access_token, session_key)
    ...
    def start_upload_goods(
        ...
        response = self._http_post("/xpay/start_upload_goods", payload, access_token, session_key)
    ...
    def query_upload_goods(
        ...
        """
        payload: dict[str, Any] = {}
        response = self._http_post("/xpay/query_upload_goods", payload, access_token, session_key)
        return models.GoodsUploadStatus(
            status=response.get("status", 0),
            upload_item=[
                models.GoodsUploadItem(**item) for item in response.get("upload_item", [])
    ...
    def start_publish_goods(
        ...
        """
        payload: dict[str, Any] = {"goods": goods}
        response = self._http_post("/xpay/start_publish_goods", payload, access_token, session_key)
    ...
    def query_publish_goods(
        ...
        """
        payload: dict[str, Any] = {}
        response = self._http_post("/xpay/query_publish_goods", payload, access_token, session_key)
        return models.GoodsPublishStatus(
            status=response.get("status", 0),
            publish_item=[
                models.GoodsPublishItem(**item) for item in response.get("publish_item", [])
    ...
    def create_funds_bill(
        ...
        response = self._http_post("/xpay/create_funds_bill", payload, access_token, session_key)
    ...
    def bind_transfer_account(
        ...
        self._http_post("/xpay/bind_transfer_accout", payload, access_token, session_key)
        return True
    ...
    def query_funds_bill(
        ...
        response = self._http_post("/xpay/query_funds_bill", payload, access_token, session_key)
    ...
    def query_recover_bill(
        ...
        response = self._http_post("/xpay/query_recover_bill", payload, access_token, session_key)
    ...
    def get_upload_file_sign(
        ...
        response = self._http_post("/xpay/get_upload_file_sign", payload, access_token, session_key)
