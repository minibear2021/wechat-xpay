...
class XPayClient(BaseClient):
    ...
    def notify_provide_goods(
        ...
        if wx_order_id:
            payload["wx_order_id"] = wx_order_id
        self._http_post("/xpay/notify_provide_goods", payload, access_token, session_key)
        return True
    ...
    def start_upload_goods(
        ...
        self._http_post("/xpay/start_upload_goods", payload, access_token, session_key)
        return True
    ...
    def start_publish_goods(
        ...
        self._http_post("/xpay/start_publish_goods", payload, access_token, session_key)
        return True
